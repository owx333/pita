...
- `data/mock400-trilingual.json` - 110-question self-assessment bank used by exam-paper mode
- `data/mock400-trilingual-data.js` - embedded 110-question self-assessment bank
...
- `scripts/generate_mock400_trilingual.py` - legacy generator for the previous 400-question trilingual combined version
